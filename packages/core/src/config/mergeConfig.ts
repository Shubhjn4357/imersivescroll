import { DEFAULT_IMMERSIVE_CONFIG, deepMerge, validateConfig } from '@immersive-scroll/shared';
...
export function mergeImmersiveConfig(input?: PartialImmersiveConfig): ImmersiveConfig {
